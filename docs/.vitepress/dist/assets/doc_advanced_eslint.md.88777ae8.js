import{_ as n,c as s,o as a,a as p}from"./app.705411ad.js";const y='{"title":"ESLint","description":"","frontmatter":{},"headers":[{"level":2,"title":"\u5B89\u88C5","slug":"\u5B89\u88C5"},{"level":2,"title":"\u914D\u7F6E package.json","slug":"\u914D\u7F6E-package-json"},{"level":2,"title":"\u5E38\u7528\u914D\u7F6E\u89C4\u5219","slug":"\u5E38\u7528\u914D\u7F6E\u89C4\u5219"},{"level":2,"title":"\u5173\u95ED ESLint \u68C0\u67E5","slug":"\u5173\u95ED-eslint-\u68C0\u67E5"}],"relativePath":"doc/advanced/eslint.md"}',t={},o=p(`<h1 id="eslint" tabindex="-1">ESLint <a class="header-anchor" href="#eslint" aria-hidden="true">#</a></h1><p>\u4E0D\u7BA1\u662F\u591A\u4EBA\u5408\u4F5C\u8FD8\u662F\u4E2A\u4EBA\u9879\u76EE\uFF0C\u4EE3\u7801\u89C4\u8303\u90FD\u662F\u5F88\u91CD\u8981\u7684\u3002\u8FD9\u6837\u505A\u4E0D\u4EC5\u53EF\u4EE5\u5F88\u5927\u7A0B\u5EA6\u5730\u907F\u514D\u57FA\u672C\u8BED\u6CD5\u9519\u8BEF\uFF0C\u4E5F\u4FDD\u8BC1\u4E86\u4EE3\u7801\u7684\u53EF\u8BFB\u6027\u3002</p><p><a href="http://eslint.cn/docs/user-guide/getting-started" target="_blank" rel="noopener noreferrer">eslint \u4E2D\u6587\u5B98\u7F51</a></p><h2 id="\u5B89\u88C5" tabindex="-1">\u5B89\u88C5 <a class="header-anchor" href="#\u5B89\u88C5" aria-hidden="true">#</a></h2><p>1\u3001\u5B89\u88C5 eslint</p><div class="language-shell"><pre><code>// \u4F60\u53EF\u4EE5\u4F7F\u7528 <span class="token function">npm</span> \u5B89\u88C5 ESLint\uFF1A
<span class="token function">npm</span> <span class="token function">install</span> eslint --save-dev
// \u7D27\u63A5\u7740\u4F60\u5E94\u8BE5\u8BBE\u7F6E\u4E00\u4E2A\u914D\u7F6E\u6587\u4EF6\uFF1A
./node_modules/.bin/eslint --init
</code></pre></div><p>\u6267\u884C init \u65F6\uFF0C\u9009\u62E9\u7684\u9009\u9879\u5982\u4E0B</p><div class="language-shell"><pre><code>\u8BE2\u95EE\uFF1AHow would you like to use ESLint? <span class="token punctuation">..</span>.
\u9009\u62E9\uFF1ATo check syntax and <span class="token function">find</span> problems

\u8BE2\u95EE\uFF1AWhat <span class="token builtin class-name">type</span> of modules does your project use? <span class="token punctuation">..</span>.
\u9009\u62E9\uFF1AJavaScript modules <span class="token punctuation">(</span>import/export<span class="token punctuation">)</span>

\u8BE2\u95EE\uFF1AWhich framework does your project use? <span class="token punctuation">..</span>.
\u9009\u62E9\uFF1AVue.js

\u8BE2\u95EE\uFF1ADoes your project use TypeScript?
\u9009\u62E9\uFF1Ayes

\u8BE2\u95EE\uFF1AWhere does your code run? <span class="token punctuation">..</span>.
\u9009\u62E9\uFF1ABrowser  <span class="token punctuation">(</span>node\u670D\u52A1\u7AEF\u9009\u62E9node\u9879<span class="token punctuation">)</span>

\u8BE2\u95EE\uFF1AWhat <span class="token function">format</span> <span class="token keyword">do</span> you want your config <span class="token function">file</span> to be in? <span class="token punctuation">..</span>.
\u9009\u62E9\uFF1AJavaScript

\u8BE2\u95EE\uFF1AWould you like to <span class="token function">install</span> them now with npm?
\u9009\u62E9\uFF1Ayes

</code></pre></div><p>\u66F4\u65B0\u6839\u76EE\u5F55.eslintrc.js (\u6CA1\u6709\u5C31\u521B\u5EFA) \uFF0C\u5982\u4E0B\uFF1A</p><div class="language-ts"><pre><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  globals<span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    withDefaults<span class="token operator">:</span> <span class="token string">&quot;readonly&quot;</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>

</code></pre></div><p>2\u3001\u5B89\u88C5 prettier</p><div class="language-shell"><pre><code><span class="token function">npm</span> <span class="token function">install</span> -D prettier eslint-plugin-prettier eslint-config-prettier

</code></pre></div><p>\u6839\u76EE\u5F55\u521B\u5EFA.prettierrc.js</p><div class="language-ts"><pre><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
...
</code></pre></div><p>3\u3001vsCode \u5B89\u88C5 ESLint\u3001Prettier \u63D2\u4EF6</p><h2 id="\u914D\u7F6E-package-json" tabindex="-1">\u914D\u7F6E package.json <a class="header-anchor" href="#\u914D\u7F6E-package-json" aria-hidden="true">#</a></h2><p>\u4FEE\u6539 package.json \u6587\u4EF6\uFF0C\u5728 script \u589E\u52A0\u4EE5\u4E0B\u9879\u76EE</p><p>\u547D\u4EE4\u8BF4\u660E\uFF1A</p><ul><li>eslint - \u8FD0\u884C eslint \u547D\u4EE4</li><li>--fix - \u4FEE\u590D\u5E76\u6821\u9A8C</li><li>--ext - \u6307\u5B9A\u6269\u5C55\u6587\u4EF6\u540D</li><li>&quot;src&quot; - \u4EE3\u8868\u53EA\u5BF9 src \u76EE\u5F55\u8FD0\u884C lint</li></ul><div class="language-json"><pre><code>  <span class="token property">&quot;scripts&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">// \u73AF\u5883\u5B9A\u4E49\u4E86\u9884\u5B9A\u4E49\u7684\u5168\u5C40\u53D8\u91CF\u3002</span>
  env<span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token comment">//\u73AF\u5883\u5B9A\u4E49\u4E86\u9884\u5B9A\u4E49\u7684\u5168\u5C40\u53D8\u91CF\u3002\u66F4\u591A\u5728\u5B98\u7F51\u67E5\u770B</span>
    ...
    <span class="token string-property property">&quot;amd&quot;</span><span class="token operator">:</span> <span class="token boolean">true</span><span class="token punctuation">,</span>
...
</code></pre></div><p><a href="https://www.jianshu.com/p/3381d00fae1d" target="_blank" rel="noopener noreferrer">Vue \u4E2D ESlint \u914D\u7F6E\u6587\u4EF6.eslintrc \u6587\u4EF6</a></p><h2 id="\u5173\u95ED-eslint-\u68C0\u67E5" tabindex="-1">\u5173\u95ED ESLint \u68C0\u67E5 <a class="header-anchor" href="#\u5173\u95ED-eslint-\u68C0\u67E5" aria-hidden="true">#</a></h2><p>\u628A.eslintrc \u914D\u7F6E\u6587\u4EF6\u4E2D\u7684 root \u6539\u4E3A false \u5373\u53EF\u3002</p>`,27),e=[o];function r(c,u,l,k,i,m){return a(),s("div",null,e)}var g=n(t,[["render",r]]);export{y as __pageData,g as default};
